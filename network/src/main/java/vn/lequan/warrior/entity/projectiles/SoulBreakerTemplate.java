...
/**
 * A basic template for a {@link SoulBreaker}.
 */
public class SoulBreakerTemplate extends Template {

    public SoulBreakerTemplate(App app) {
        super(app, 30, 30);
    }
    ...
    private EnumMap<Direction, Animation> extractMoveAnimations() {
        ...
        for (Direction direction : Direction.values()) {
            Animation animation = createAnimation(frameLength, "soul_breaker_move", 1);
    ...
    private EnumMap<Direction, Animation> extractExplodeAnimations() {
        ...
        for (Direction direction : Direction.values()) {
            Animation animation = createAnimation(frameLength, "soul_breaker_explode", 9);
            animation.setBounce(false);
